...
typedef struct _SensorPacket {
    ...
    bool has_trace_heater_state;
    int32_t trace_heater_state;
    bool has_trace_heater_th;
    int32_t trace_heater_th;
    bool has_trace_heater_tc;
    int32_t trace_heater_tc;
    bool has_trace_heater_current_temp;
    int32_t trace_heater_current_temp;
} SensorPacket;
...
#define SensorPacket_trace_heater_state_tag 30
#define SensorPacket_trace_heater_th_tag 31
#define SensorPacket_trace_heater_tc_tag 32
#define SensorPacket_trace_heater_current_temp_tag 33
...
#define SensorPacket_FIELDLIST(X, a)                                                               \
    ...
    X(a, STATIC, OPTIONAL, INT32, trace_heater_state, 30)                                          \
    X(a, STATIC, OPTIONAL, INT32, trace_heater_th, 31)                                             \
    X(a, STATIC, OPTIONAL, INT32, trace_heater_tc, 32)                                             \
    X(a, STATIC, OPTIONAL, INT32, trace_heater_current_temp, 33)
